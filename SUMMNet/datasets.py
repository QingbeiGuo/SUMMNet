...
def build_dataset(is_train, args):
    ...
    print("args.data_set:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::", args.data_set)
    if args.data_set == 'Pets':
        dataset = datasets.OxfordIIITPet(args.data_path, split="trainval", download=True, transform=transform)
        nb_classes = 37
    elif args.data_set == 'StanfordCars':
        dataset = datasets.StanfordCars(args.data_path, download=True, transform=transform)
        nb_classes = 196
